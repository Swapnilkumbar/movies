...
gulp.task('dist', function(done) {
    ...
    rimraf.sync('C:/xampp/htdocs/server/public/client');

    //copy dist folder into laravel public folder
    gulp.src(['./dist/client/browser/**/*', '!./dist/client/browser/index.html', '!./dist/client/browser/stats.json']).pipe(gulp.dest('C:/xampp/htdocs/server/public/client'));
    ...
    const laravelViewPath = 'C:/xampp/htdocs/server/resources/views/app.blade.php';
